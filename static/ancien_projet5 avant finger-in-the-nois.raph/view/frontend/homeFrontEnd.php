    ...
    <article class="deuxiemeArticle">
        ...
        <div class="displayGame">
            <div id="contenuOfDisplayGame">
                ...
                <a href="public/game3/index.php"> <img src="public/img/jump.JPG" alt="astronaute">
                    <div class="titleBtn unlockedGame">En construction - attentions aux bugs et crash en tous genres</div>
                </a>
            </div>
        </div>
    </article>
